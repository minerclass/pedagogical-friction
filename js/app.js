...
(function () {
  ...
  var STAGES = [
    {
      era: "Pre-literate", name: "Primary Orality",
    ...
    {
      era: "Manuscript to print", name: "Literacy",
    ...
    {
      era: "Broadcast era", name: "Secondary Orality",
    ...
    {
      era: "Mid-2000s to early 2020s", name: "Algorithmic Secondary Orality",
    ...
    {
      era: "Generative-AI present", name: "Tertiary Algorithmicity",
  ...
  var DIMS = {
    noetic: {
      color: "var(--noetic)", tag: "The Head", name: "Noetic friction",
    ...
    rhetorical: {
      color: "var(--rhetorical)", tag: "The Room", name: "Rhetorical friction",
    ...
    existential: {
      color: "var(--existential)", tag: "The World", name: "Existential friction",
    ...
    infrastructural: {
      color: "var(--infrastructural)", tag: "The System", name: "Infrastructural friction",
  ...
  var CARDS = [
    { n: 1, v: "Teacher", t: "Students use AI to brainstorm possible claims, then draft the essay without AI.",
      note: "The drafting, the noetic core, stays with the student; AI touches only idea generation. The framework asks whether generating claims was itself the skill the task meant to build." },
    { n: 2, v: "Teacher", t: "A student submits an AI-assisted essay and then defends the thesis in a one-on-one conference.",
      note: "The oral defense recovers rhetorical and existential friction the artifact alone no longer guarantees. Understanding is tested at the point of accountability." },
    { n: 3, v: "Teacher", t: "A multilingual learner uses AI translation to understand the assignment directions before starting.",
      note: "Likely reduces exclusionary friction by removing a language barrier to access, without removing the learning goal, as long as the tool stays with directions rather than the disciplinary work." },
    { n: 4, v: "Teacher", t: "AI summarizes a source for the class before students read the original text.",
      note: "Convenient, yet it can pre-empt the interpretive labor of first contact with a text. Noetic friction may be removed before it has a chance to do its work." },
    { n: 5, v: "Teacher", t: "A school blocks all AI tools because district guidance is unclear.",
      note: "An infrastructural reaction to opacity. It may protect struggle or impose a blunt, exclusionary barrier; the framework asks whether the block preserves learning or only manages risk." },
    { n: 6, v: "Teacher", t: "A teacher uses AI to generate first-draft feedback on every student essay.",
      note: "This shifts the teacher's labor, not the student's. The question is whether feedback still carries a human reader's judgment that students can be accountable to." },
    { n: 7, v: "Student", t: "A student asks AI to explain a concept they do not understand, then completes the problem set alone.",
      note: "AI acts as a tutor that scaffolds understanding while the generative work of the problem set stays with the student. Often productive, unless the explanation quietly becomes the answer." },
    { n: 8, v: "Student", t: "A student has AI write the introduction, then writes the rest of the paper themselves.",
      note: "A partial substitution. The framework asks whether the introduction was where the thinking lived or a low-stakes on-ramp into the student's own work." },
    { n: 9, v: "Student", t: "A student with a writing-related disability uses AI to turn their own notes into an outline.",
      note: "The ideas originate with the student; AI handles a transcription and structuring barrier. This reads as accommodation reducing exclusionary friction rather than bypass." },
    { n: 10, v: "Student", t: "A student uses AI to generate counterarguments to stress-test their own thesis before a debate.",
      note: "Here AI raises rhetorical friction instead of lowering it, forcing the student to defend against stronger opposition. Struggle is added, not removed." }
  ];
